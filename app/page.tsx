...
export default function Home() {
  return (
    <div className='w-full bg-white h-full rounded-md drop-shadow-lg p-6 overflow-scroll text-start '>
      ...
      <br />
      As a full-stack software developer i decided to make my own site from
      scratch using experience which i gained during my career. <br /> <br />
      <p className='text-xl  text-center'>GOALS</p> <br />
      <ol className='list-decimal list-inside'>
        <li>
          Simplify employers or customers get to know more about me, and my
          experience.
        </li>
      ...
      <ul className='list-inside list-disc'>
        ...
        <li>
          FEEDBACK - You can look in feedbacks wat people leaved for me, and
          leave your feedback too if have something (authorisation required)
        </li>
